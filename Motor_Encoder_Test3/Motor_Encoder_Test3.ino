...
#define ENC1_A 10   //Encoder pulse A (LEFT ENCODER)
#define ENC1_B 11   //Encoder pulse B
#define ENC2_A 12   //Encoder pulse A (RIGHT ENCODER)
#define ENC2_B 13   //Encoder pulse B
